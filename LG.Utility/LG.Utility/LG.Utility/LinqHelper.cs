...
namespace LG.Utility {
    public static class LinqHelper {
        ...
        /// <returns></returns>
        public static IEnumerable<T> GetIenumberable<T>(IEnumerable<T> dataList, Func<T, bool> FunWhere, Func<IEnumerable<T>, IEnumerable<T>> FunOrder, int PageSize, int PageIndex, out int dataCout)
        {
            ...
            if (FunOrder != null) getList=FunOrder.Invoke(getList);//getList = getList.OrderByDescending(FunOrder);
